...
PNG_LIBS   = libpng
PNG_CFLAGS = $(shell /usr/bin/pkg-config --cflags $(PNG_LIBS))
PNG_LDLIBS = $(shell /usr/bin/pkg-config --libs $(PNG_LIBS))
...
CC     = gcc
LL     = gcc
CFLAGS = -Wall -Wextra -std=c99  -D_GNU_SOURCE $(PNG_CFLAGS)
LFLAGS = $(PNG_LDLIBS)
