...
/* Inicializa um pool de frame_ids (slots) */
...
/* Salva um frame YUV420 em PNG usando FFmpeg CLI */
...
int main(int argc, char *argv[])
{
    ...
    /* NOTE:
        Erro acontece porque a função av_register_all() foi removida nas
       versões recentes do FFmpeg (>= 4.0).
    */
    /* av_register_all();*/ /* ⛔ Obsoleta — remova esta linha */
    ...
    List frame_pool;
    /* máximo de 10 capturas simultâneas */
