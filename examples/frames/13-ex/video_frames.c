...
int main(int argc, char *argv[])
{
    ...
    while (elmt != NULL)
    {
        ...
        while (i < 320)
        {
            desenhar_faixa(img, i, j - 10, 255, 0,
                           0); // faixa vermelha no topo
            desenhar_faixa(img, i + j, j - 10, 0, 255, 0);     // faixa verde
            desenhar_faixa(img, i + 2 * j, j - 10, 0, 0, 255); // faixa azul
