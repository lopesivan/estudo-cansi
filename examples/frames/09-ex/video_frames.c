    ...
    while (elmt != NULL)
    {
        ...
        for (int y = 0; y < img->altura; y++)
        {
            for (int x = 0; x < img->largura; x++)
            {
                ...
                img->dados[offset + 0] = 255 - img->dados[offset + 0]; // R
                img->dados[offset + 1] = 255 - img->dados[offset + 1]; // G
                img->dados[offset + 2] = 255 - img->dados[offset + 2]; // B
            }
        }
