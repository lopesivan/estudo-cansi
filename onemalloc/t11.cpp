// g++ -std=c++20 -O2 -Wall -Wextra -pedantic t11.cpp -o app
#include <cstddef>
#include <cstdlib>
...
// ---------------------------------------------------------------------------
// TODO: sum_array
// Range-based com std::span (C++20, recomendado)
#include <numeric>
#include <span>

template <typename T> T sum_array(std::span<T> array) {
...
int main() {
  ...
  // Don't touch this!
  // clang-format off
  auto total = sum_array(std::span{*matriz2d, dims2D[0] * dims2D[1]});
  std::cout << "sum_array ="
            << total
            << '\n';
  // clang-format on
